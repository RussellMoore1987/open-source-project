...
<body>
        ...
        <?php
            if(!empty($tables_array)) {
                foreach($tables_array as $table) {
                    echo "<div>";
                        echo "<a style='font-size: 20px; margin-bottom: 5px; text-decoration: none;' href='dev_tools.php?selecttable=" . $table .  "'>" . $table . "</a>";
                    echo "</div>";  
                }
            }
        ?>
    ...
    <a style="color: darkgreen; margin-lefT: 50px; padding: 10px; border: 1px solid darkgreen;" href="dev_tools.php?actions=all">ALL ACTIONS, DROP CREATE INSERT</a>
    <a style="color: darkgreen; margin-lefT: 50px; padding: 10px; border: 1px solid darkgreen;" href="dev_tools.php?actions=addMainTestUser">ADD MAIN TEST USER</a>
    <br>
    <br>
    <br>
    <br>
