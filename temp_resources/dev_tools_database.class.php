...
class Database {
    ...
    // @ queries start
        ...
        public function create_bookmarks_table() {
            ...
            $sql .= "url VARCHAR(255), ";
            $sql .= "name VARCHAR(50), ";
            $sql .= "FOREIGN KEY (userId) REFERENCES users(id) ON DELETE CASCADE ) ENGINE=InnoDB";
        ...
        public function create_content_table() {
            ...
            $sql .= "content JSON, ";
            $sql .= "KEY createdBy (createdBy)) ENGINE=InnoDB";
        ...
        public function create_posts_to_media_content_table() {
            ...
            $sql .= "FOREIGN KEY (mediaContentId) REFERENCES media_content(id) ON DELETE CASCADE ) ENGINE=InnoDB";
        ...
        public function create_posts_to_tags_table() {
            ...
            $sql .= "FOREIGN KEY (postId) REFERENCES posts(id) ON DELETE CASCADE, ";
            $sql .= "FOREIGN KEY (tagId) REFERENCES tags(id) ON DELETE CASCADE ) ENGINE=InnoDB";
        ...
        public function create_posts_to_labels_table() {
            ...
            $sql .= "FOREIGN KEY (postId) REFERENCES posts(id) ON DELETE CASCADE, ";
            $sql .= "FOREIGN KEY (labelId) REFERENCES labels(id) ON DELETE CASCADE ) ENGINE=InnoDB";
        ...
        public function create_posts_to_categories_table() {
            ...
            $sql .= "FOREIGN KEY (postId) REFERENCES posts(id) ON DELETE CASCADE, ";
            $sql .= "FOREIGN KEY (categoryId) REFERENCES categories(id) ON DELETE CASCADE ) ENGINE=InnoDB";
        ...
        public function create_media_content_to_tags_table() {
            ...
            $sql .= "FOREIGN KEY (mediaContentId) REFERENCES media_content(id) ON DELETE CASCADE, ";
            $sql .= "FOREIGN KEY (tagId) REFERENCES tags(id) ON DELETE CASCADE ) ENGINE=InnoDB";
        ...
        public function create_content_to_tags_table() {
            ...
            $sql .= "FOREIGN KEY (contentId) REFERENCES content(id) ON DELETE CASCADE, ";
            $sql .= "FOREIGN KEY (tagId) REFERENCES tags(id) ON DELETE CASCADE ) ENGINE=InnoDB";
        ...
        public function create_users_to_permissions_table() {
            ...
            $sql .= "FOREIGN KEY (permissionId) REFERENCES permissions(id) ON DELETE CASCADE ) ENGINE=InnoDB";
