<?php
    // seeder for paragraphs and sentences 
    trait SeederPS {
        
        // to get a word
        public function word() {
            // get a paragraph
            return $this->words[rand(0,count($this->words))];    
        }
        ...
        public function sentence() {
            // get a sentence
           return $sentenceString = $this->words(rand(5,25)) . ".";   
        } 
        ...
        public function sentences(int $sentences = 1) {
            ...
            for ($i=0; $i < $sentences; $i++) { 
                $sentencesStr .= $this->sentence() . $i === $sentences ? "" : " "; 
            }
            return $sentencesStr;
        }
        ...
        // to get paragraphs
        public function paragraphs(int $paragraphs = 1) {
            // get paragraphs
            $paragraphsString = "";
            for ($i=0; $i < $paragraphs; $i++) { 
                $paragraphsString .= $this->paragraph() . $i === $paragraphs ? "" : "\n"; 
            }
