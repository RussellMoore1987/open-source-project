...
foreach ($apiClassList_array as $key => $value) {
    ...
    if ($value::$getApiParameters) {
        ...
        // build end point array
            ...
            $tempEndPoint_arry["/" . $key]["methods"]["availableMethods"]["GET"] = "To get {$key} information";

            // set ["methods"]["GET"]["parameters"]["noParamsSent"]
            $tempEndPoint_arry["/" . $key]["methods"]["parameters"]["noParamsSent"]["description"] = "When no parameters are passed then all {$key} are returned";
            $tempEndPoint_arry["/" . $key]["methods"]["parameters"]["noParamsSent"]["example"] = PUBLIC_LINK_PATH . "api/v1/" . $key . "/";
