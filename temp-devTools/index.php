    ...
    <div class="dev-tool-container">
        ...
        <div class="table-view-container">
            ...
            <div class="button-options">
                ...
                <div class="btn flex-center"><i class="far fa-comment"></i></div>
                <div class="btn flex-center"><i class="fas fa-trash-alt"></i></div>
                <div class="btn flex-center"><i class="fas fa-power-off"></i></div>
            </div>
            <!-- style bars -->
